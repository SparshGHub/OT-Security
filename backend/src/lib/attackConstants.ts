// Minimal attack constants ported from attachments - used for feasibility checks
...
export const ZONE_TO_SOURCES: Record<string, string[]> = {
  Field: ['LOCAL_MAINTENANCE_LAPTOP', 'PHYSICAL_USB', 'PHYSICAL_ACCESS', 'IIOT_GATEWAY', 'EWS'],
  Control: ['EWS', 'HMI', 'LOCAL_MAINTENANCE_LAPTOP', 'PHYSICAL_USB', 'HISTORIAN'],
  DMZ: ['HISTORIAN', 'REMOTE_ACCESS_VPN', 'CORPORATE_NETWORK', 'EWS', 'IIOT_GATEWAY'],
  Enterprise: ['CORPORATE_NETWORK', 'REMOTE_ACCESS_VPN', 'HISTORIAN']
};
